...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # lesson_one event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the lesson_one thread. This is achieved by idling
    ...
    # Storage for lesson_one event loop references
